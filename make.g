...
//    $ go install -tags "pro" -ldflags "-s -w -X main.CompileDate=%{Format(`YYYY-MM-DD`,Now())}"
//    $ cp ${GOPATH}/bin/eonza /home/ak/app/eonza.com/eonza
//    return

    $ go install -tags "tray pro" -ldflags "-s -w -X main.CompileDate=%{Format(`YYYY-MM-DD`,Now())}"
